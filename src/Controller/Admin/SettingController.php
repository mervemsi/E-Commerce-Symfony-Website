...
class SettingController extends Controller
{
    ...
    {
        $setdata= $settingRepository->findAll(); //butun veriyi oku
        //dump($setdata);
        //die();
        if(!$setdata) //veri tabani tablosu bos ise
        {   
            ...
            //echo $setdata[0]->getId();
        
        return $this->redirectToRoute('admin_setting_edit', ['id' => $setdata[0]->getId()]);//0 kullaniyoruz cunku tum recordlari alir
    ...
    public function edit(Request $request, Setting $setting): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('warning','Updating product is successful');
