...
class CategoryController extends Controller
{
    ...
    {
        $catlist = $categoryrepository->findBy(['parentid' => 0]); // repository depo anlaminda veriler depo ediliyor, veritabani sorgularinin yapildigi diger yer aslinda modelin bir parcasidir
    ...
    public function edit(Request $request, $id, $pid, CategoryRepository $categoryrepository, Category $category): Response
    {
        ...
        //dump($catname);
        //die();
        //bilgilerin gelip gelmedigini dump komutlari ile gorebiliriz
