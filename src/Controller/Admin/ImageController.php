...
class ImageController extends Controller
{
    ...
    public function new(Request $request, $pid, ImageRepository $imageRepository): Response
    {
        ...
        //if ($form->isSubmitted() && $form->isValid()) {
            //burada upload ışlemi gerçekleştirmemiz lazım 
            //submıt olayı gerçekleştiyse
            //form işlemleri

            $file=$request->files->get('imagename'); //formda valueya verilen ad
    ...
    /**
     * @Route("/{id}/{pid}", name="admin_image_erase", methods="GET")
     */
    public function erase(Request $request, Image $image, $pid): Response
    {
            $em = $this->getDoctrine()->getManager();
            $em->remove($image);
            $em->flush();
